...
def init_tokens():
    ...
    for t, token in enumerate(tokens_read):
        ...
        # print('tokens[token[0]]' + tokens[token[0]])
        # print('forevers_read[t]' + forevers_read[t])
        # print('expires_read[t][0]' + expires_read[t][0])
            ...
            if tokenTF(splitedAuth[0]):
                ...
                if expireExist(splitedAuth[0]):
                    ...
                    # 토큰 남은 유효기간이 음수라면
                        ...
                        authInterface.auth_remove_row_by_token_name(splitedAuth[0])
